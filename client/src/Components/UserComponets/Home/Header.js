...
function Header() {
    ...
    return (
        <nav class="flex shadow" >
            <div class="w-full flex p-4 px-5 md:px-10 items-center justify-between">
                <div>
                    <Link to={"/home"}>
                ...
                <div class="flex items-center gap-3" id="navbarSupportedContent">
                    <form class="">
                        <button className='border rounded-md p-1 px-2 bg-green-500 text-white' onClick={handleLogoutUser} type="submit">logout</button>
                    </form>
